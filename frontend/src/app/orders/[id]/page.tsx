              ...
              <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                ...
                {!["DELIVERED", "COMPLETED", "CANCELLED"].includes(
                  ...
                  <button
                    ...
                    onClick={cancelOrder}
                    disabled={cancelling}
                    className="mt-3 block rounded-xl border border-red-200 bg-red-50 px-4 py-2 text-sm font-black text-red-700 transition hover:bg-red-100 disabled:cursor-not-allowed disabled:opacity-50"
                  >
